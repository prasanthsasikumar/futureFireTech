...
// Cross Module References
	...
	UE4DUINO_API class UEnum* Z_Construct_UEnum_UE4Duino_ELineEnd();
	UE4DUINO_API class UFunction* Z_Construct_UFunction_USerial_BytesToFloat();
	UE4DUINO_API class UFunction* Z_Construct_UFunction_USerial_BytesToInt();
	UE4DUINO_API class UFunction* Z_Construct_UFunction_USerial_Close();
	UE4DUINO_API class UFunction* Z_Construct_UFunction_USerial_FloatToBytes();
	...
	UE4DUINO_API class UFunction* Z_Construct_UFunction_USerial_IntToBytes();
	UE4DUINO_API class UFunction* Z_Construct_UFunction_USerial_IsOpened();
	UE4DUINO_API class UFunction* Z_Construct_UFunction_USerial_LineEndToStr();
...
{
	extern UE4DUINO_API class UPackage* Z_Construct_UPackage__Script_UE4Duino();
	static UEnum* Singleton = nullptr;
	if (!Singleton)
	{
		extern UE4DUINO_API class UEnum* Z_Construct_UEnum_UE4Duino_ELineEnd();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ELineEnd(ELineEnd_StaticEnum, TEXT("/Script/UE4Duino"), TEXT("ELineEnd"), false, nullptr, nullptr);
	...
	uint32 Get_Z_Construct_UEnum_UE4Duino_ELineEnd_CRC() { return 1992485330U; }
	void USerial::StaticRegisterNativesUSerial()
	{
		...
		FNativeFunctionRegistrar::RegisterFunctions(Class, AnsiFuncs, 24);
	}
	UFunction* Z_Construct_UFunction_USerial_BytesToFloat()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("BytesToFloat"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x14022401, 65535, sizeof(Serial_eventBytesToFloat_Parms));
	...
	UFunction* Z_Construct_UFunction_USerial_BytesToInt()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("BytesToInt"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x14022401, 65535, sizeof(Serial_eventBytesToInt_Parms));
	...
	UFunction* Z_Construct_UFunction_USerial_FloatToBytes()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("FloatToBytes"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x14422401, 65535, sizeof(Serial_eventFloatToBytes_Parms));
	...
	UFunction* Z_Construct_UFunction_USerial_IntToBytes()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("IntToBytes"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x14422401, 65535, sizeof(Serial_eventIntToBytes_Parms));
	...
	UFunction* Z_Construct_UFunction_USerial_LineEndToStr()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("LineEndToStr"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(Serial_eventLineEndToStr_Parms));
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_BytesToFloat(), "BytesToFloat"); // 4207693163
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_BytesToInt(), "BytesToInt"); // 1009538125
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_Close(), "Close"); // 648606897
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_FloatToBytes(), "FloatToBytes"); // 2961003505
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_Flush(), "Flush"); // 3985754101
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_GetBaud(), "GetBaud"); // 1456707172
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_GetPort(), "GetPort"); // 1423263168
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_IntToBytes(), "IntToBytes"); // 1563240727
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_IsOpened(), "IsOpened"); // 3939028203
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_LineEndToStr(), "LineEndToStr"); // 3652608694
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_Open(), "Open"); // 3297957252
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_OpenComPort(), "OpenComPort"); // 2379231294
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_Print(), "Print"); // 1538016833
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_Println(), "Println"); // 1381343117
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_ReadByte(), "ReadByte"); // 2210656709
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_ReadBytes(), "ReadBytes"); // 3568310799
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_ReadFloat(), "ReadFloat"); // 1115001515
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_ReadInt(), "ReadInt"); // 3327912624
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_Readln(), "Readln"); // 2735718587
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_ReadString(), "ReadString"); // 522518885
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_WriteByte(), "WriteByte"); // 144995969
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_WriteBytes(), "WriteBytes"); // 990493789
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_WriteFloat(), "WriteFloat"); // 3393017237
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_WriteInt(), "WriteInt"); // 3907129069
	...
	IMPLEMENT_CLASS(USerial, 1422556665);
	...
	UPackage* Z_Construct_UPackage__Script_UE4Duino()
	{
		...
		if (!ReturnPackage)
		{
			ReturnPackage = CastChecked<UPackage>(StaticFindObjectFast(UPackage::StaticClass(), nullptr, FName(TEXT("/Script/UE4Duino")), false, false));
