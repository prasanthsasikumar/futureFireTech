...
// Cross Module References
	...
	void USerial::StaticRegisterNativesUSerial()
	{
		...
		FNativeFunctionRegistrar::RegisterFunctions(Class, AnsiFuncs, 19);
	}
	...
	UClass* Z_Construct_UClass_USerial()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USerial_Readln(), "Readln"); // 242374238
	...
	IMPLEMENT_CLASS(USerial, 3308004605);
